...
import uz.azizbekxurramov.jaxonnoma.databinding.Fragment6Binding

class Fragment6 : Fragment(), MainContrakt.View {
    private lateinit var binding: Fragment6Binding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter?.loadNewsByCategory("tr", "entertainment", this.getString(R.string.api_key))
