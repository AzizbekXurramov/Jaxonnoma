...
import uz.azizbekxurramov.jaxonnoma.databinding.Fragment5Binding

class Fragment5 : Fragment(), MainContrakt.View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter?.loadNewsByCategory("tr", "sports", this.getString(R.string.api_key))
