...
import uz.azizbekxurramov.jaxonnoma.databinding.Fragment7Binding

class Fragment7 : Fragment(), MainContrakt.View {
    private lateinit var binding: Fragment7Binding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter?.loadNewsByCategory("tr", "health", this.getString(R.string.api_key))
